...
namespace TwitchToLeagueChat.Managers
{
    public class AuthClass
    {
        ...
        public static RegionData ReadSystemRegionData(string systemFile, string region)
        {
            ...
            {
                AllowLoginQueueFallback = true,//bool.Parse(regionDataYaml["rso"]["allow_lq_fallback"].ToString()),
                Kount = new Kount
                {
        ...
        public static RiotAuthToken GetLoginToken(string username, string password, RegionData regionData, RiotAuthOpenIdConfiguration config)
        {
            ...
            {
                return new RiotAuthToken(RiotAuthResult.ConProblem, null, dsid, regionData);
            }
